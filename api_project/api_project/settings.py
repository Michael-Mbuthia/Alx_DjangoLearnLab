...
SECRET_KEY = 'django-insecure-n+!2jarv*4g%j9owlk35bnr_$ef7wbmtw(lsn#3#=1(rch5l5q'
...
REST_FRAMEWORK = {
    ...
    # Permissions
    #
    # By default, all API endpoints require an authenticated user unless a view
    # overrides `permission_classes`.
